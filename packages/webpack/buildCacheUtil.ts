...
export type OriginalBuildCache<State> = Parameters<typeof setBuildCache<State>>[1];
export type ServerIslandRegistry = Parameters<IslandPreparer["prepare"]>[0];
export type OriginalStaticFile = ReturnType<OriginalBuildCache<unknown>["readFile"]>;
